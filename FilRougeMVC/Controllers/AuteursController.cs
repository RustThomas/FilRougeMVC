...
namespace FilRougeMVC.Controllers
{
    ...
    public class AuteursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nom,Prenom,Email,Telephone,Grade")] Auteur auteur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nom,Prenom,Email,Telephone,Grade")] Auteur auteur)
        {
            if (id != auteur.Id)
            {
                return NotFound();
